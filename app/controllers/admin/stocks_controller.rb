class Admin::StocksController < AdminController
  ...
  def update
    respond_to do |format|
      if @admin_stock.update(admin_stock_params)
        format.html { redirect_to admin_product_stocks_url(@admin_stock.product, @admin_stock), notice: "Stock was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_prodcut_stocks_url, notice: "Stock was successfully destroyed." }
