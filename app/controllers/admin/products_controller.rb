class Admin::ProductsController < AdminController
  ...
  #       end
  #     end
  #     redirect_to admin_product_path, notice: "Product updated successfuly"
  #   else
  ...
  def update
    ...
    existing_images = @admin_product.images

    if @admin_product.update(admin_product_params.except(:images))
      attach_images(admin_product_params[:images]) if admin_product_params[:images].present?
      redirect_to admin_product_path, notice: 'Product Updated Successfuly'
    else
      @admin_product.images.attach(existing_images)
      render :edit, status: :unprocessable_entity
    end
  end
